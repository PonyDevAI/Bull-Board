...
export const executionBackends = [
  { name: "backend-1", status: "online" as const, used: 2, total: 4, lastHeartbeat: "2s ago", lastError: "" },
  { name: "backend-2", status: "online" as const, used: 1, total: 4, lastHeartbeat: "5s ago", lastError: "" },
  { name: "backend-3", status: "offline" as const, used: 0, total: 4, lastHeartbeat: "2m ago", lastError: "connection timeout" },
];
...
export const quality = {
  ...
  topReasons: [
    ...
    { reason: "execution backend crash", count: 1 },
  ],
  blockedTasks: [
...
export const activity = [
  ...
  { time: "10:31:45", type: "backend online", desc: "backend-2", ref: "backendId=backend-2" },
  ...
  { time: "10:25:33", type: "backend offline", desc: "backend-3", ref: "backendId=backend-3" },
  ...
  { time: "10:18:00", type: "backend online", desc: "backend-1", ref: "backendId=backend-1" },
];
